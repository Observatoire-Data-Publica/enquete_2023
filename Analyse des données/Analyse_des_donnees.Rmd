...
saving_plot <- function(graph, name) {
  ggsave(file = glue("../Graphiques/PNG/{name}.png"), plot = graph, width = 30, height = 45)
  ggsave(file = glue("../Graphiques/SVG/{name}.svg"), plot = graph, width = 30, height = 45)
}
```
...
dataviz <- function(nom_col){
    ...
    graph <- plot_grid(all_plots, legend, nrow = 2, rel_heights = c(1, 0.1))
