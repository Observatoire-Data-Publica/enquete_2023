...
Les ***réponses*** complètes, enrichies du type de structure, nettoyées des doublons et anonymisées sont consultables sur ce lien : 
...
test <- map2(.x = c(13, 16),
            ...
            .f = ~rbind(glue("all_stat{.x}")))
test2 <- rbind(lapply(ls(pattern="^test"), function(x) get(x)))

table_recap_simple(13)
table_recap_simple(16)
```
