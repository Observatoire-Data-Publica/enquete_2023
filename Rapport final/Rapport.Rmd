...
L'Observatoire Data Publica est ravi de vous présenter l'édition 2023 de son baromètre annuel sur la data dans les territoires. Cette enquête, réalisée avec le soutien de la Banque des Territoires, de l'ANCT, de la Poste, d'Orange et en partenariat avec la Gazette des Communes, a pour objectif de suivre l'évolution de la maturité des collectivités (et EPCI bien sûr, mais aussi d'autres organismes locaux, tels les EPSN) en matière de données, mais aussi de thématiques proches, telles que la cybersécurité ou l'intelligence artificielle. 
...
[Voir toutes les données détaillées pour cette question.](https://datactivist.coop/enquete_data_publica/Analyse%20des%20donn%C3%A9es/Analyse_des_donnees.html#33_Selon-vous,_la_ma%C3%AEtrise_de_la_donn%C3%A9e_constitue-t-elle_un_outil_pertinent_pour_r%C3%A9pondre_aux_enjeux_environnementaux_de_votre_territoire_)
...
Si ce podium reste similaire à celui observé l'an dernier, les cas d'usage que les collectivités répondantes indiquent vouloir déployer dans l'année à venir démontrent l'impact de la crise énergétique : le patrimoine d'une part, l'énergie et l'éclairage public d'autre part, sont en tête. 15 et 14% des collectivités (hors communes de moins de 3500 habitants) prévoient de déployer un cas d'usage sur ces thématiques, l'environnement étant la troisième thématique la plus citée (13%).
...
[Voir toutes les données pour cette question.](https://datactivist.coop/enquete_data_publica/Analyse%20des%20donn%C3%A9es/Analyse_des_donnees.html#31_Pour_chacun_de_ces_domaines,_pouvez-vous_pr%C3%A9ciser_si_votre_structure_a_engag%C3%A9_ces_deux_derni%C3%A8res_ann%C3%A9es_un_ou_plusieurs_projets_ou_exp%C3%A9rimentations_en_mati%C3%A8re_d%E2%80%99utilisation_des_donn%C3%A9es,_ou_pr%C3%A9voit_d%E2%80%99en_engager_au_cours_des_douze_prochains_mois_)
...
[Voir toutes les données pour cette question.](https://datactivist.coop/enquete_data_publica/Analyse%20des%20donn%C3%A9es/Analyse_des_donnees.html#52_Quels_sont,_selon_vous,_les_principaux_obstacles_%C3%A0_la_diffusion_d%E2%80%99outils_innovants_en_mati%C3%A8re_de_gestion_des_donn%C3%A9es_)

Notons enfin un possible déficit d'information : ainsi, 38% des répondants affirment que les services de leur structure ne sont pas bien informés des obligations d’open data applicables en vertu de la Loi Lemaire. Ce chiffre monte à 57% dans les communes, et toutes les communes entre 3.500 et 10.000 communes répondantes se rangent dans cette situation. Même dans les métropoles, 28% d'entre elles sont concernées par cette méconnaissance perçue. Ces chiffres ne seront pas sans interroger les différents acteurs de l'open data, qui ont pourtant largement communiqué sur le sujet depuis 2016.
...
[Voir toutes les données pour cette question.](https://datactivist.coop/enquete_data_publica/Analyse%20des%20donn%C3%A9es/Analyse_des_donnees.html#61_Pensez-vous_que_les_services_de_votre_structure_sont_bien_inform%C3%A9s_des_obligations_d%E2%80%99open_data_applicables_depuis_2018_%C3%A0_toutes_les_administrations_publiques_de_plus_de_50_ETP,_et_notamment_les_collectivit%C3%A9s_de_plus_de_3_500_habitants_)
...
[Voir toutes les données pour cette question.](https://datactivist.coop/enquete_data_publica/Analyse%20des%20donn%C3%A9es/Analyse_des_donnees.html#54_Pour_chacune_des_directions_suivantes,_pouvez-vous_nous_dire_si_leur_implication_en_mati%C3%A8re_de_gestion_des_donn%C3%A9es_est)
...
[Voir toutes les données pour cette question.](https://datactivist.coop/enquete_data_publica/Analyse%20des%20donn%C3%A9es/Analyse_des_donnees.html#55_Dans_votre_organisation,_ces_fonctions_consacr%C3%A9es_%C3%A0_la_donn%C3%A9e_existent-elles_ou_seront-elles_cr%C3%A9%C3%A9es_dans_les_douze_prochains_mois_)
...
Les structures publiques d'appui ou de mutualisation sont ainsi souvent sollicitées. 47% des répondants déclarent ainsi collaborer avec une **plateforme régionale d'information géographique** ; si cela concerne davantage les grandes collectivités (régions, départements et métropoles en particulier), 7% des communes déclarent leur intention d'y avoir recours dans l'année à venir - 17% des communes de 3.500 à 10.000 habitants. 
...
La collaboration avec des **collectivités plus grandes** (typiquement, un EPCI ou une région) est également populaire (38%). Mais paradoxalement, elle l'est... surtout chez les grandes collectivités, qui collaborent donc entre elles ! Ainsi, peu de communes de moins de 10.000 habitants déclarent collaborer avec des collectivités plus grandes - mais 17% des communes de 3.500 à 10.000 habitants prévoient de le faire dans année. 

Les collaborations avec des **associations de collectivités**, telles qu'OpenDataFrance ou la FNCCR, sont également fréquentes (38%), mais répondent au même schéma : elles sont plus fréquentes chez les grandes collectivités que dans les petites, qui pourraient pourtant potentiellement en avoir davantage besoin. En revanche, les intentions affichées sont plus faibles : seules 5% des répondants prévoient de collaborer avec une association de collectivités dans l'année. 
...
[Voir toutes les données pour cette question.](https://datactivist.coop/enquete_data_publica/Analyse%20des%20donn%C3%A9es/Analyse_des_donnees.html#56_Avec_lesquels_de_ces_partenaires_potentiels_collaborez-vous,_ou_pr%C3%A9voyez-vous_de_le_faire,_au_sujet_des_donn%C3%A9es_)
...
[Voir toutes les données pour cette question.](https://datactivist.coop/enquete_data_publica/Analyse%20des%20donn%C3%A9es/Analyse_des_donnees.html#81_Aujourd%E2%80%99hui,_les_donn%C3%A9es_de_votre_structure_sont_majoritairement_h%C3%A9berg%C3%A9es)
...
[Voir toutes les données pour cette question.](https://datactivist.coop/enquete_data_publica/Analyse%20des%20donn%C3%A9es/Analyse_des_donnees.html#82_Votre_structure_a-t-elle_d%C3%A9ploy%C3%A9_les_technologies_suivantes,_ou_pr%C3%A9voit-elle_de_le_faire_dans_les_12_prochains_mois_)
...
[Voir toutes les données pour ces questions.](https://datactivist.coop/enquete_data_publica/Analyse%20des%20donn%C3%A9es/Analyse_des_donnees.html#71_Votre_structure_a-t-elle_d%C3%A9j%C3%A0_mis_en_place_des_projets_ou_exp%C3%A9rimentations_ayant_recours_%C3%A0_l%E2%80%99intelligence_artificielle_)
